# ============================================================================
# figure_cimic_survival_classification.R
# ============================================================================
# Purpose:
#   Classify each CIMIC-associated gene as Beneficial / Adverse / NS based on
#   cross-cohort concordant univariate survival associations (METABRIC + SCANB),
#   then visualize the distribution across Fun-CIM vs Dys-CIM trajectories
#   as a stacked percentage bar plot.
#
#   Two versions are produced:
#     - raw p-value   (< 0.05)  -> Results/..._pvalue.png
#     - BH-adjusted p (< 0.05)  -> Results/..._padj_BH.png
#
# Input:
#   Datasets/Univariate_CIMIC_Clinical_Analysis.csv
...
build_figure(df, "_p_value",  "raw p < 0.05",
             "Results/figure_cimic_survival_classification_pvalue.png")

build_figure(df, "_p_adj_BH", "BH-adjusted p < 0.05",
             "Results/figure_cimic_survival_classification_padj_BH.png")
