# =============================================================================
# MAKE MASTER INDUCTION DATAFRAME DIRECTLY (TNBC_CL_Epirubicin dataset)
# =============================================================================
# Purpose:
#   Create the TNBC_CL_Epirubicin master‑induction dataframe directly from the
#   final clustered‑sample dataframe without relying on master_induction_limma_lib.R.
#
# Input:
#   clustered_df (TNBC_CL_Epirubicin)
#
# Expected structure:
#   - One row per sample
...
#   - LIMMA robust + trend
#   - duplicateCorrelation because this is cell line data (not independent)
...
# file location (TNBC_CL_Epirubicin clustered matrix)
clustered_csv_location <- "D:/OneDrive - University of Florida/Gbadamosi Lab/Mohammed Gbadamosi/Gbadamosi_Lab_GitHub/CIMIC/oncoimmunology_paper/Datasets/TNBC_CL_Epirubicin/tnbc_cl_epi_clustered_plot_df.csv"
...
output_dir <- "D:/OneDrive - University of Florida/Gbadamosi Lab/Mohammed Gbadamosi/Gbadamosi_Lab_GitHub/CIMIC/oncoimmunology_paper/Datasets/TNBC_CL_Epirubicin"
...
cat("\n============================================================\n")
cat("MASTER INDUCTION DATAFRAME (TNBC_CL_Epirubicin)\n")
cat("============================================================\n")
...
# -----------------------------------------------------------------------------
# 7. RUN LIMMA (integrated duplicateCorrelation for cell‑line data)
# -----------------------------------------------------------------------------
...
cat("\n============================================================\n")
cat("MASTER INDUCTION COMPLETE (TNBC_CL_Epirubicin)\n")
cat("============================================================\n")
...
# Uncomment when you are satisfied with the result.
    ...
    csv_file_master_induction <- file.path(output_dir, "tnbc_cl_master_induction_df.csv")
    fwrite(master_induction_df, csv_file_master_induction)

    csv_file_cluster_induction <- file.path(output_dir, "tnbc_cl_clustered_plot_df.csv")
