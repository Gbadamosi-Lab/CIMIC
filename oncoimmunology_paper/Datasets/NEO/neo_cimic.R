...
res <- CIMIC(
  ...
  # One sample per patient (19 unique NEO ids), so there is no replicate structure
  # to model: every sample is independent. With NULL the fit is numerically
  # identical to plain unblocked limma (CIMIC_limma_1.0.0.R).
  block_metadata = NULL,
  all_gene_sets = NULL,
