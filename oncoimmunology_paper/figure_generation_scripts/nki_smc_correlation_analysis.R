# ============================================================================
# nki_smc_correlation_analysis.R
# ============================================================================
...
#          clustered expression matrix. The script performs a Mann‑Whitney U
#          test for each gene, derives r_rb, obtains a p‑value, applies BH
#          correction, and writes the results to a CSV file.
#
# Input:
#   oncoimmunology_paper/Datasets/NKI_SMC/nki_smc_combine_clustered_plot_df.csv
# Output:
#   oncoimmunology_paper/Results/correlation_analysis.csv
# Author: Mohammed Gbadamosi (adapted from 11_correlation_analysis.R)
# ============================================================================
...
# ---------------------------------------------------------------------------
# Use a correlation magnitude cutoff of 0.6 and BH‑adjusted p‑value < 0.05.
# According to the request, genes associated with cluster 1 (negative r_rb)
# are labeled "Dys-CIM" and those associated with cluster 2 (positive r_rb)
# are labeled "Fun-CIM".
cor_df <- cor_df %>%
  dplyr::mutate(
...
# ---------------------------------------------------------------------------
output_path <- "oncoimmunology_paper/Results/nki_smc_correlation_analysis.csv"
