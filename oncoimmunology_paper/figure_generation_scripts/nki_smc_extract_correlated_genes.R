# ============================================================================
# nki_smc_extract_correlated_genes.R
# ============================================================================
# Purpose: Using the correlation analysis results, extract the genes that are
#          significantly correlated with the Dys‑CIM and Fun‑CIM trajectories
#          and label them in the master induction dataframe.
#
# Input files:
#   1. oncoimmunology_paper/Results/nki_smc_correlation_analysis.csv
#   2. oncoimmunology_paper/Datasets/NKI_SMC/nki_smc_master_induction_df.csv
# Output files:
#   - oncoimmunology_paper/Results/nki_smc_fun_cim_genes.csv
#   - oncoimmunology_paper/Results/nki_smc_dys_cim_genes.csv
#   - oncoimmunology_paper/Results/nki_smc_master_labeled.csv (optional)
# ============================================================================
...
master_path      <- "oncoimmunology_paper/Datasets/NKI_SMC/nki_smc_master_induction_df.csv"
...
if (length(gene_id_col_master) == 0) {
  stop("No gene identifier column found in master induction dataframe.")
}
...
fun_cim_path <- "oncoimmunology_paper/Results/nki_smc_fun_cim_genes.csv"
dys_cim_path <- "oncoimmunology_paper/Results/nki_smc_dys_cim_genes.csv"
master_labeled_path <- "oncoimmunology_paper/Results/nki_smc_master_labeled.csv"
...
message("Extraction complete. Files written to Results folder.")
