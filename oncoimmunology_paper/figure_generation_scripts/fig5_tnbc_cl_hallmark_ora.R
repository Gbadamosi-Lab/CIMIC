...
#          the TNBC‑CL dataset correlation analysis (tnbc_cl_correlation_analysis.R).
...
# ---------------------------------------------------------------------------
# Load correlation results (TNBC‑CL dataset)
# ---------------------------------------------------------------------------
...
run_hallmark_ora <- function(gene_list, set_name) {
  ...
  # Save plot
  plot_file <- file.path(output_dir, paste0("fig5_tnbc_cl_", set_name, "_Hallmark_ORA.png"))
  ggsave(plot_file, plot = p, width = 14, height = 10, dpi = 300)
  message("Saved plot: ", plot_file)

  # Save enrichment table
  csv_file <- file.path(output_dir, paste0("fig5_tnbc_cl_", set_name, "_Hallmark_ORA.csv"))
...
message("Hallmark ORA analysis for TNBC‑CL completed.")
