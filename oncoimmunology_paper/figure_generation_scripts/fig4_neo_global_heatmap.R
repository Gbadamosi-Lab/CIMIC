# ============================================================================
# fig4_neo_global_heatmap.R
# ============================================================================
# Purpose: Create a heatmap visualising global induction differences for the NEO dataset.
# Input:  oncoimmunology_paper/Datasets/NEO/neo_master_induction_df.csv
# Output: oncoimmunology_paper/Results/fig4_neo_global_heatmap.png
# ============================================================================
...
# Load the master induction data frame for the NEO dataset
master_induction_df <- fread(
  "oncoimmunology_paper/Datasets/NEO/neo_master_induction_df.csv",
  data.table = FALSE
)
...
png(
  filename = file.path(output_dir, "fig4_neo_global_heatmap.png"),
  width = 6,
  height = 12,
  units = "in",
  res = 300
